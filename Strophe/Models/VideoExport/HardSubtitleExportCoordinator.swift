...
final class HardSubtitleExportCoordinator: ObservableObject {
    ...
    #if os(iOS)
        private var continuedProcessingIdentifier: String?
    #endif
    ...
    func cancel() {
        ...
        #if os(iOS)
            if let identifier = continuedProcessingIdentifier {
                BGTaskScheduler.shared.cancel(
                    taskRequestWithIdentifier: identifier
                )
                continuedProcessingIdentifier = nil
                progress = nil
                completionMessage =
                    HardSubtitleVideoExportError.cancelled
        ...
        private func submitContinuedProcessingTask(
            ...
            let didRegister = scheduler.register(
                ...
                MainActor.assumeIsolated {
                    ...
                    self.continuedProcessingIdentifier = nil
                    self.beginExport(
                        project: project,
                        settings: settings,
                        destinationURL: destinationURL,
            ...
            do {
                ...
                continuedProcessingIdentifier = identifier
                return true
            } catch {
