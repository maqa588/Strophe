...
nonisolated final class CoreMLParakeetJA: @unchecked Sendable {
    ...
    /// the beginning of a Japanese word and the next window emits the complete
    /// word (for example `法医` + `法医学者`).
